...
--
-- Hôte : localhost
-- Généré le : jeu. 02 déc. 2021 à 18:28
...
CREATE TABLE `actualites` (
  ...
  `auteurs` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `artistes` (
  ...
  `provenance` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `pays` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `site_web` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  `myspace` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `evenements` (
  ...
  `infos_supp` mediumtext COLLATE utf8_unicode_ci,
  `lieu_id` tinyint(3) NOT NULL,
  `artiste_id` tinyint(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, '2020-07-08 23:30:00', '5.00', '(Concert dessiné par Philippe Girard et Francis Desharnais)', 1, 3),
(2, '2020-07-08 22:30:00', '5.00', NULL, 1, 4),
(3, '2020-07-08 21:30:00', '5.00', '(lancement de cassette)', 1, 5),
(4, '2020-07-09 01:30:00', '5.00', '(ex-Cougarettes et Mathias Mental)', 1, 10),
(5, '2020-07-10 00:30:00', '5.00', '(ex-We Are Wolves et Mathématique)', 1, 11),
(6, '2020-07-09 22:30:00', '5.00', NULL, 1, 12),
(7, '2020-07-09 23:30:00', '5.00', NULL, 1, 14),
(9, '2020-07-10 23:59:00', '5.00', NULL, 1, 18),
(14, '2020-07-11 23:00:00', '5.00', NULL, 1, 30),
(15, '2020-07-11 23:59:00', '5.00', NULL, 1, 31),
(17, '2020-07-10 18:00:00', NULL, NULL, 2, 25),
(21, '2020-07-10 20:30:00', NULL, 'L\'incroyable Cabaret Olibrius Folkestra Circus présente: Marisol-Josée, Alex Drapeau, Boutch, Gab Paquet, Olivier Légaré, L\'abobinable Fanny Fay, la troupe de feu Fogo Rasto', 2, 24),
(25, '2020-07-08 17:00:00', NULL, NULL, 4, 9),
(27, '2020-07-10 18:00:00', NULL, NULL, 4, 28),
(30, '2020-07-11 21:30:00', NULL, NULL, 5, 37),
(33, '2020-07-08 22:00:00', NULL, NULL, 6, 7),
(34, '2020-07-08 23:00:00', NULL, NULL, 6, 8),
(35, '2020-07-09 23:00:00', NULL, NULL, 6, 13),
(36, '2020-07-09 22:00:00', NULL, 'Concert dessiné (Bordeaux-Qc)', 6, 15),
(37, '2020-07-10 23:00:00', NULL, NULL, 6, 21),
(39, '2020-07-08 20:30:00', NULL, NULL, 6, 24),
(41, '2020-07-11 23:30:00', NULL, '(lancement d\'album)', 6, 33),
(42, '2020-07-08 20:00:00', NULL, NULL, 3, 12),
(43, '2020-07-08 19:30:00', NULL, NULL, 2, 18),
(44, '2020-07-08 21:30:00', NULL, NULL, 5, 10),
(46, '2020-07-09 21:30:00', NULL, NULL, 3, 33),
(48, '2020-07-09 19:30:00', NULL, NULL, 4, 31);
...
CREATE TABLE `lieux` (
  ...
  `no_civique` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `rue` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `code_postal` varchar(6) COLLATE utf8_unicode_ci NOT NULL,
  `indications` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `site_web_lieu` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
